                              ...
                              <td><table cellspacing=2 cellpadding=0 width=100% border=0>
                                  <tbody>
                                    <tr>
                                      ...
                                      <td valign=bottom align=left width=566><span class="font">当前位置</span>:<a class=p12a href="product.asp">首页</a> &gt;&gt; 在线留言 </td>
                                    </tr>
                                  </tbody>
                                </table></td>
                            </tr>
                            ...
                            <tr>
                              <td align="center" class="content">
                                  ...
                                  <input name="mymail" type="hidden" value="hxlman@163.com" />
                                    <tr>
                                      <td height="40" colspan="2" align="left" class="font12">请输入您的问题、建议及产品订购信息： </td>
                                    </tr>
                                    <tr>
                                      <td align="right" class="font11">您的姓名: </td>
                                      <td align="left"><input name="yourname" type="text" />
                                      <span style="color: red;">*</span>                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="right" class="font11">公司名称:</td>
                                      <td align="left"><input name="company" type="text" size="40" />
                                      <span style="color: red;">*</span>                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="right" class="font11">电话:</td>
                                    ...
                                    <tr>
                                      <td align="right" class="font11">地址:</td>
                                      <td align="left"><input name="addr" type="text" size="40" />
                                        <span style="color: red;">*</span></td>
                                    </tr>
                                    <tr>
                                      <td align="right" class="font11"> 邮编:</td>
                                      <td align="left"><input name="code" type="text" />                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="right" class="font11">备注:</td>
                                      <td align="left"><textarea name="content" cols="26" rows="3"></textarea>                                      </td>
                                    </tr>
                                    <tr>
                                      <td colspan="2"><input name="Submit1" type="submit" value="提交发送" />
                                        &nbsp;
                                        <input name="Reset1" type="reset" value="　重填　" />                                      </td>
                                    </tr>
									</form>
                                  </table>
                              </td>
