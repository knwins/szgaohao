...
%>
    ...
    </TABLE><!-- #BeginLibraryItem "Library/left_en.lbi" --><table cellspacing="0" cellpadding="3" width="100%" border="0">
        <tbody>
          <tr>
              ...
              <td><table cellspacing=2 cellpadding=0 width=100% border=0>
                  <tbody>
                    <tr>
                      ...
                      <td valign=bottom align=left width=566><span class="font">Location</span>:<a class=p12a href="index.asp">Home</a> &gt;&gt; <%=cname %></td>
                    </tr>
                  </tbody>
                </table></td>
            </tr>
