                            ...
                            <td><table cellspacing="2" cellpadding="0" width="100%" border="0">
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="bottom" align="left" width="566"><span class="font">Location</span>:<a class="p12a" href="index.asp">Home</a> &gt;&gt;<%=session("catename")%></td>
                                  </tr>
                                </tbody>
                            </table></td>
                          </tr>
                  ...
                  <tr>
                    <td height="32" align="center"><table border="0" cellspacing="0" cellpadding="0" class="font">
                        <form name="form2" method="post" action="product.asp">
                          <tr>
                            <td align="center" height="22">Total:<b><%=total%></b>&nbsp;&nbsp;<%=page%>/<b><%=rs.pagecount%></b> page <a href="product.asp?page=1">First</a>
                              <%if page>1 then%>
                              <a href=product.asp?page=<%=page-1%>>Previous</a>
                              <%else%>
                              Previous
                              <%end if%>
                              <%if page<rs.pagecount   then%>
                              <a href=product.asp?page=<%=page+1%>>Next</a>
                              <%else%>
                              Next
                              <%end if%>
                              <a href=product.asp?page=<%=rs.pagecount%>>Last</a>
                              <select name="page">
