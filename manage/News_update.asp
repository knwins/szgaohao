...
<br>
<table border="1" width="80%" align="center" bordercolorlight="#c0c0c0" cellspacing="1" cellpadding="3" bordercolordark="#ffffff" >
  <form name="frmsubmit" action=News_upd.asp method=post>
    ...
    <tr align="center">
      <td>内容：</td>
      <td align=left valign="top" class="unnamed2" bgcolor="#ffffff"><textarea name="content" style="width:700px;height:450px;visibility:hidden;"><%=CONTENT%></textarea>
            </td>
    </tr>
    <tr>
